import { PeriodoItem, HourValue, Dato, EstadoCielo, WeatherFormated, Dia } from './weather.model'
...
export function mapWeatherResponse (weather: Dia, name: string, date: Date): WeatherFormated {
  return {
    name: name,
    date,
